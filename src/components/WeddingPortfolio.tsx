...
export default function WeddingPortfolio({ onOpenWedding }: Props) {
  ...
  if (me && (!me.phone || me.profileState !== 'confirmed')) return <ProfileSheet required initialName={googleName} onClose={() => undefined} />;
